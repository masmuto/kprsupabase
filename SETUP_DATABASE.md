# Setup Database Supabase Baru

## Credentials Baru

**Supabase URL:** https://cdornopbukdwgysgpvrf.supabase.co
**API Key:** sb_publishable_fKrA2exUo9nxLyyNmQksLA_X8K5nzAk
**Database Password:** $umateraP11
...
SQL script sudah tersedia di file:
```
/home/z/my-project/supabase-setup.sql
```

Atau copy script di bawah ini langsung ke SQL Editor:
...
Setelah SQL selesai di-run:
1. Refresh Preview Panel
2. Atau klik **"Open in New Tab"** di atas Preview Panel
...
- **marketing** / **marketing123** (Marketing Team)
- **sales** / **sales123** (Sales Team)
...
### Visitors/Leads (5 leads)
| Name | Phone | Location | Status |
|------|-------|----------|--------|
| Budi Santoso | 081234567890 | Jakarta Selatan | Baru |
| Siti Rahayu | 081234567891 | Jakarta Pusat | Follow Up |
| Andi Wijaya | 081234567892 | Bogor | Hot Lead |
| Dewi Lestari | 081234567893 | Bandung | Closing |
| Eko Pratama | 081234567894 | Bekasi | Baru |

### Agents (3 agents)
- Ahmad Wijaya (Senior Agent)
- Sarah Putri (Property Consultant)
- Budi Santoso (Sales Agent)
